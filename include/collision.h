...
bool CheckRectRectCollision(const Vector4* rectangle_1,
                            const Vector4* rectangle_2);

bool CheckRectLineCollision(const Vector2* rectangle_point_1,
...
bool CheckLineLineCollision(const Vector2* line_1_point_1,
                            const Vector2* line_1_point_2,
                            const Vector2* line_2_point_1,
                            const Vector2* line_2_point_2);

bool CheckPolyPointCollision(const Polygon2D* polygon, const Vector2* point);
